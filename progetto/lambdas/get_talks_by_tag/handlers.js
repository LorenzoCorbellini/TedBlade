...
module.exports.get_by_tag = async (event, context, callback) => {
    ...
    // Prendiamo i valori, se non ci sono vogliamo valori predefiniti
    // Così restituiamo x documenti per volta
    ...
    try {
        ...
        // Query: documenti che contengono il tag richiesto
        // Saltiamo i primi tot documenti in base al numero di pagina selezionato
        // Recupero al massimo n documenti
        const talks = await talk.find({ tags: body.tag })
            .skip((body.doc_per_page * body.page) - body.doc_per_page)
            .limit(body.doc_per_page);

        // Passiamo i documenti al layer NLP (se non già fatto)
        ...
        // Restituiamo in formato JSON il risultato
        return callback(null, {
            statusCode: 200,
